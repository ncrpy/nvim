...
" molokai
let g:rainbow_conf.guifgs = ['skyblue1', 'darkorange1', 'seagreen1', 'firebrick1']
let g:rainbow_conf.separately.lisp.guifgs = ['skyblue1', 'darkorange1', 'seagreen1', 'firebrick1', 'darkorchid1']

" TeX
let g:rainbow_conf.separately.tex.parentheses = ['start=/(/ end=/)/', 'start=/\[/ end=/\]/', 'start=/{/ end=/}/']
